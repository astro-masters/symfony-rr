...
alias sym="symfony console"
alias dconsole="cd /var/www/api && XDEBUG_MODE=debug,develop XDEBUG_TRIGGER=PHPSTORM php bin/console"
alias dphp="XDEBUG_MODE=debug,develop XDEBUG_TRIGGER=PHPSTORM php"
alias console="cd /var/www/api && XDEBUG_MODE=off php bin/console"
...
alias pu="phpunit"
alias puf="XDEBUG_MODE=off php bin/phpunit -c ./phpunit.dist.xml --colors=always --filter"
alias pud='dphp bin/phpunit -c ./phpunit.dist.xml --colors=always --filter'
